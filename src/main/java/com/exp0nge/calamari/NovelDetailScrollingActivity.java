...
public class NovelDetailScrollingActivity extends AppCompatActivity implements UpdatesFragment.OnListFragmentInteractionListener {
    private static List<String> PageTitles = Arrays.asList(
            "Details",
            "Chapters",
            "Reviews");

    private NovelDetailScrollingActivity.SectionsPagerAdapter mSectionsPagerAdapter;
